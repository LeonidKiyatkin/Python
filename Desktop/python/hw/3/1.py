...
"""
l_season = ["Зима", "Зима", "Весна", "Весна", "Весна",
            "Лето", "Лето", "Лето", "Осень", "Осень", "Осень", "Зима"]
d_season = {1: "Зима", 2: "Зима", 3: "Весна", 4: "Весна", 5: "Весна", 6: "Лето",
            7: "Лето", 8: "Лето", 9: "Осень", 10: "Осень", 11: "Осень", 12: "Зима"}

num_month = int(input('Введите месяц в виде целого числа от 1 до 12: '))

print(f'Результат через список: {l_season[num_month-1]}')
print(f'Результат через список: {d_season[num_month]}')
